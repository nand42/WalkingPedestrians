...
\node[blue!20!black] at (4.7,3.6) {$\gamma(x, y, t)$};

\end{tikzpicture}
}%
\captionsetup{width=.8\linewidth}
\caption{This figure represents a trajectory in the \emph{continuous space} as the blue line $\gamma$.
...
The numbers are the associated to the D2Q9 indexes to those moves, also called \emph{k-directions} and showed in (Figure \ref{fig:D2Q9_k}).
The coordinate's changes are explicit in (Figure \ref{fig:D2Q9_c}).
}
