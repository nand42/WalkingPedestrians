...
\caption{Index associated to possible movements from the center cell to another. Every transition is associated with a number for the index $k$. The figure represents how to identify the nine cells with the $k$ index.}
\label{fig:D2Q9_k}
\end{minipage}
\begin{minipage}[c]{0.5\linewidth}
\centering
