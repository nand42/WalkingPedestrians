...
Lets call them: $A, B, C, D$, with the following values:
\begin{equation}
\begin{split}
A=
\left(
...
\end{equation*}
In this second case would be instead:
\begin{equation}
\begin{split}
...
To solve this problem it's essential the use of a computer calculation.
