...
For the first two models is pretty difficult to see a good overlaying, even if it's not null.
For the last two models is easy to see the improvement made by adding the \emph{time} information.
